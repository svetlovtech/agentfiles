...
_EXPORT_MAP: dict[str, tuple[str, str]] = {
    ...
    "resolve_target_name": ("agentfiles.models", "resolve_target_name"),
    "item_from_directory": ("agentfiles.models", "item_from_directory"),
    "item_from_file": ("agentfiles.models", "item_from_file"),
    "parse_frontmatter": ("agentfiles.frontmatter", "parse_frontmatter"),
    "SKILL_MAIN_FILE": ("agentfiles.frontmatter", "SKILL_MAIN_FILE"),
